...
**Read [`AGENT.md`](https://github.com/MettaMazza/Fold-Protein/blob/main/AGENT.md) first.** Every derivation and expansion must route through the engine
...
- **[Super Parity: Achieving 0.9891 TM-Score in Zero-Parameter Protein Folding via the 24-Lattice Dihedral Orbit Expansion](https://github.com/MettaMazza/Fold-Protein/blob/main/papers/Super_Parity_Zero_Parameter_Protein_Folding.md)**
- **[Levinthal's Paradox Dissolved: Parameter-Free Protein Folding and the Genetic Code](https://github.com/MettaMazza/Fold-Protein/blob/main/papers/Levinthals_Paradox_Dissolved_Parameter_Free_Protein_Folding_and_the_Genetic_Code.md)**
- The 0.9891 structure: [`verify/1ubq_test_24_lattice.pdb`](https://github.com/MettaMazza/Fold-Protein/blob/main/verify/1ubq_test_24_lattice.pdb) · all predictions: `verify/1ubq_*.pdb`, `./1ubq_autonomous*.pdb`
