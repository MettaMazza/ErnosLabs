...
function mesh_frame() {
    let w, i, a, alpha, n, h, dist, dy, ctx, b, dx, nodes, j, count;
    ctx = window.ernCtx;
...
function narration_text() {
    let n, txt, cls, i, nodes, parts, doc, dt;
