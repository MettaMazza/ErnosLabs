...
function mesh_frame() {
    let h, n, j, dy, i, alpha, count, a, b, ctx, nodes, dx, dist, w;
    ctx = window.ernCtx;
...
function narration_text() {
    let dt, cls, doc, txt, n, nodes, i, parts;
