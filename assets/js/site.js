...
function mesh_frame() {
    let h, dist, w, j, dx, dy, alpha, n, nodes, ctx, a, i, count, b;
    ctx = window.ernCtx;
...
function narration_text() {
    let cls, nodes, txt, i, parts, dt, n, doc;
