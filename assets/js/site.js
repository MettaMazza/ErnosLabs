...
function mesh_frame() {
    let count, b, w, nodes, dx, j, i, n, h, ctx, dy, alpha, a, dist;
    ctx = window.ernCtx;
...
function narration_text() {
    let doc, i, nodes, parts, cls, dt, n, txt;
