...
function mesh_frame() {
    let w, dx, n, a, dist, nodes, count, h, ctx, b, dy, i, alpha, j;
    ctx = window.ernCtx;
...
function narration_text() {
    let n, dt, i, doc, nodes, parts, cls, txt;
