...
function mesh_frame() {
    let n, b, ctx, dy, w, i, a, j, alpha, count, h, dist, dx, nodes;
    ctx = window.ernCtx;
...
function narration_text() {
    let parts, doc, nodes, n, txt, i, dt, cls;
