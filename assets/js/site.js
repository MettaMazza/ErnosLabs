...
function mesh_frame() {
    let b, nodes, alpha, n, count, dx, a, ctx, h, i, dy, w, j, dist;
    ctx = window.ernCtx;
...
function narration_text() {
    let n, nodes, parts, txt, cls, doc, i, dt;
