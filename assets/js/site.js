...
function mesh_frame() {
    let dy, h, w, i, j, dx, a, b, n, alpha, nodes, ctx, count, dist;
    ctx = window.ernCtx;
...
function narration_text() {
    let i, dt, nodes, parts, txt, n, cls, doc;
