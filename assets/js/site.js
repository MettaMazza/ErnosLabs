...
function mesh_frame() {
    let i, j, b, dy, ctx, nodes, a, dist, count, w, dx, alpha, h, n;
    ctx = window.ernCtx;
...
function narration_text() {
    let doc, dt, n, parts, cls, nodes, i, txt;
