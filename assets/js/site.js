...
function mesh_frame() {
    let w, h, alpha, i, dist, a, ctx, count, b, j, nodes, dx, dy, n;
    ctx = window.ernCtx;
...
function narration_text() {
    let n, txt, cls, i, dt, nodes, doc, parts;
