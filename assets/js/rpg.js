...
function main() {
    let goblin_struct, enemies, target, enemy, i, party_idx, ok, orc_struct, hero, healer_struct, member, round, orc, hero_ref, party, enemy_len, r, party_len, goblin, hero_struct, healer;
    console.log("=============================================");
