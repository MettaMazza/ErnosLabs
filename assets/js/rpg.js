...
function main() {
    let party, enemy_len, party_idx, round, ok, goblin_struct, healer, party_len, enemies, orc_struct, hero_struct, goblin, enemy, member, r, i, healer_struct, hero, orc, hero_ref, target;
    console.log("=============================================");
