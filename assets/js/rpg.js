...
function main() {
    let member, enemy, party_idx, orc_struct, healer, i, round, hero, enemy_len, healer_struct, orc, party, ok, party_len, hero_ref, r, enemies, target, goblin_struct, hero_struct, goblin;
    console.log("=============================================");
