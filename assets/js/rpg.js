...
function main() {
    let party_idx, enemy_len, party_len, healer, round, hero, goblin_struct, ok, hero_ref, goblin, i, enemy, r, enemies, orc, healer_struct, member, target, hero_struct, party, orc_struct;
    console.log("=============================================");
