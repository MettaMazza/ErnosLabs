...
function main() {
    let orc, hero, enemy_len, hero_ref, goblin, party_idx, target, goblin_struct, enemies, party_len, ok, hero_struct, healer, party, enemy, orc_struct, round, healer_struct, member, i, r;
    console.log("=============================================");
