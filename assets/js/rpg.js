...
function main() {
    let party_idx, orc_struct, enemies, enemy_len, r, healer_struct, party, party_len, target, enemy, hero, member, hero_struct, goblin, healer, hero_ref, i, ok, round, orc, goblin_struct;
    console.log("=============================================");
