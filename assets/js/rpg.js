...
function main() {
    let i, ok, goblin_struct, hero, party_len, hero_ref, healer, goblin, member, enemy, healer_struct, hero_struct, party, round, enemy_len, orc, orc_struct, enemies, party_idx, r, target;
    console.log("=============================================");
