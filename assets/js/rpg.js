...
function main() {
    let target, enemy_len, hero_ref, ok, party, enemy, healer_struct, i, party_len, goblin_struct, r, member, round, healer, party_idx, hero, hero_struct, goblin, orc, enemies, orc_struct;
    console.log("=============================================");
