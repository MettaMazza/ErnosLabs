...
function main() {
    let goblin, i, goblin_struct, party, member, enemies, hero_struct, healer, hero, round, party_len, party_idx, ok, healer_struct, orc_struct, target, r, enemy_len, hero_ref, orc, enemy;
    console.log("=============================================");
