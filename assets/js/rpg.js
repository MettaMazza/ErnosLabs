...
function main() {
    let hero, ok, orc_struct, healer_struct, hero_ref, enemy, party_len, goblin, party, enemies, hero_struct, healer, member, r, i, target, party_idx, round, orc, enemy_len, goblin_struct;
    console.log("=============================================");
