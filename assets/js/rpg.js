...
function main() {
    let party, goblin, party_len, target, round, hero_struct, goblin_struct, r, healer_struct, orc_struct, healer, enemies, orc, i, hero, ok, enemy_len, member, hero_ref, enemy, party_idx;
    console.log("=============================================");
