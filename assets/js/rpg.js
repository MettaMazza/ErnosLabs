...
function main() {
    let hero, ok, goblin_struct, hero_struct, healer, member, hero_ref, target, enemy_len, goblin, i, party_idx, enemy, enemies, party, orc_struct, round, party_len, r, orc, healer_struct;
    console.log("=============================================");
