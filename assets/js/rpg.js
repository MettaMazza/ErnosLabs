...
function main() {
    let party, hero, r, orc, goblin, round, target, i, member, healer_struct, enemy_len, party_len, hero_ref, enemy, goblin_struct, party_idx, ok, orc_struct, enemies, healer, hero_struct;
    console.log("=============================================");
