...
function main() {
    let enemies, target, hero_ref, healer, party, r, orc, party_len, goblin_struct, party_idx, healer_struct, hero_struct, hero, enemy_len, i, goblin, member, enemy, round, ok, orc_struct;
    console.log("=============================================");
