...
function main() {
    let enemy_len, hero_ref, party_idx, healer_struct, round, healer, hero, hero_struct, party, goblin, goblin_struct, r, enemies, target, orc_struct, i, enemy, ok, orc, member, party_len;
    console.log("=============================================");
