...
function main() {
    let hero, hero_struct, round, goblin_struct, orc_struct, party, party_len, member, hero_ref, enemy_len, i, enemies, goblin, healer_struct, healer, target, orc, enemy, party_idx, r, ok;
    console.log("=============================================");
