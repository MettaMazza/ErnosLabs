...
function main() {
    let orc, party, party_len, goblin_struct, party_idx, enemy_len, orc_struct, target, round, hero, ok, enemy, enemies, healer_struct, hero_ref, member, i, r, hero_struct, goblin, healer;
    console.log("=============================================");
