...
function main() {
    let healer_struct, party_idx, goblin, orc_struct, hero_struct, healer, hero, r, target, enemies, party_len, member, goblin_struct, round, ok, hero_ref, enemy_len, i, orc, party, enemy;
    console.log("=============================================");
