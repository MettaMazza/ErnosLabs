...
function main() {
    let hero, healer, target, enemy_len, ok, orc, orc_struct, r, goblin_struct, enemy, round, hero_ref, member, i, party_idx, enemies, party_len, hero_struct, party, goblin, healer_struct;
    console.log("=============================================");
