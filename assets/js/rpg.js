...
function main() {
    let party_idx, orc, healer_struct, party_len, i, hero, enemies, round, party, goblin_struct, member, hero_ref, ok, goblin, target, enemy_len, orc_struct, enemy, healer, hero_struct, r;
    console.log("=============================================");
