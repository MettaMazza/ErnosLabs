...
function main() {
    let healer, party_len, round, party_idx, target, enemy, hero_struct, hero_ref, orc, orc_struct, hero, ok, r, healer_struct, enemy_len, i, party, member, goblin, enemies, goblin_struct;
    console.log("=============================================");
