...
function main() {
    let hero_ref, hero, round, r, healer, goblin, orc, hero_struct, enemies, party_len, target, party, ok, goblin_struct, orc_struct, healer_struct, enemy_len, party_idx, i, member, enemy;
    console.log("=============================================");
