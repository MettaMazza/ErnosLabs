...
function main() {
    let hero_ref, enemy, orc, hero_struct, round, goblin_struct, goblin, healer_struct, party_len, party_idx, enemies, member, i, orc_struct, ok, party, enemy_len, healer, r, target, hero;
    console.log("=============================================");
