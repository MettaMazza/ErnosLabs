...
function main() {
    let goblin, party_idx, hero_struct, ok, hero_ref, target, orc_struct, i, r, orc, party_len, hero, goblin_struct, enemy_len, party, round, member, healer_struct, enemy, healer, enemies;
    console.log("=============================================");
